QT.core_private.VERSION = 6.5.3
QT.core_private.name = QtCore
QT.core_private.module =
QT.core_private.libs = $$QT_MODULE_LIB_BASE
QT.core_private.includes = $$QT_MODULE_INCLUDE_BASE/QtCore/6.5.3 $$QT_MODULE_INCLUDE_BASE/QtCore/6.5.3/QtCore
...
QT.core_private.disabled_features = clock-gettime system-doubleconversion dladdr futimens getauxval getentropy glib glibc icu inotify journald system-libb2 linkat system-pcre2 poll_ppoll poll_pollts poll_poll poll_select qqnx_pps renameat2 slog2 statx syslog backtrace lttng etw ctf forkfd_pidfd poll-exit-on-error use_bfd_linker use_gold_linker use_lld_linker use_mold_linker android-style-assets developer-build private_tests debug reduce_exports no_direct_extern_access mips_dsp mips_dspr2 neon arm_crc32 arm_crypto posix_fallocate alloca_h stack-protector-strong system-zlib stdlib-libcpp dbus-linked libudev openssl dlopen relocatable intelcet
