...
add_library(Qt6::Mqtt STATIC IMPORTED)
...
set_target_properties(Qt6::MqttPrivate PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "\$<\$<BOOL:\$<TARGET_PROPERTY:Qt6::Mqtt,_qt_module_has_private_headers>>:>;\$<\$<BOOL:\$<TARGET_PROPERTY:Qt6::Mqtt,_qt_module_has_private_headers>>:>;\$<\$<BOOL:\$<TARGET_PROPERTY:Qt6::Mqtt,_qt_module_has_private_headers>>:${_IMPORT_PREFIX}/include/QtMqtt/6.5.3>;\$<\$<BOOL:\$<TARGET_PROPERTY:Qt6::Mqtt,_qt_module_has_private_headers>>:${_IMPORT_PREFIX}/include/QtMqtt/6.5.3/QtMqtt>"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/Qt6MqttTargets-*.cmake")
